        ...
        <section className="pt-32 pb-12 bg-zinc-950">
          <div className="container-custom">
            <div className="max-w-3xl mx-auto">
              <Link
                href="/blog"
                className="inline-flex items-center text-sm text-gray-400 hover:text-primary transition-colors font-sans mb-8"
              >
              ...
              <div className="flex items-center gap-4 text-sm text-gray-400 font-sans pb-8 border-b border-white/10">
