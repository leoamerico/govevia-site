...
export default function PlataformaView({ initialView }: { initialView: PersonaId | null }) {
  ...
  return (
    <>
      {/* ── PERSONAS ──────────────────────────────────────────────────────── */}
      <section className="py-20 bg-slate-900" id="personas">
        <div className="container-custom">
          <div className="mb-10">
            ...
            <p className="text-slate-200 font-sans leading-relaxed max-w-2xl">
              ...
              <code className="text-amber-400 bg-white/5 px-1 rounded text-xs">?view=</code>.
            </p>
          </div>
            ...
            {(Object.keys(PERSONAS) as PersonaId[]).map((id) => {
              ...
              return (
                <button
                  ...
                  className={
                    isActive
                      ? 'flex items-center gap-2.5 rounded-xl px-5 py-2.5 text-sm font-bold text-slate-950 bg-amber-400 shadow-[0_0_16px_rgba(251,191,36,0.3)] transition-all'
                      : 'flex items-center gap-2.5 rounded-xl border border-white/15 bg-white/5 px-5 py-2.5 text-sm font-semibold text-slate-300 transition-all hover:border-amber-400/40 hover:bg-white/10 hover:text-white'
                  }
                >
                  <span>{p.label}</span>
                  <span
      ...
      {/* ── CAPACIDADES ─────────────────────────────────────────────────────── */}
      <section className="py-20 bg-slate-950" id="capacidades">
        <div className="container-custom">
          <div className="mb-10">
            <p className="text-xs font-mono uppercase tracking-widest text-amber-400 mb-3">
              Capacidades
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    <div
                      className={`flex-shrink-0 text-xl font-mono select-none mt-0.5 ${
                        isEvidence ? 'text-amber-400' : 'text-slate-500'
                      }`}
                      aria-hidden="true"
                    >
                      {cap.icon}
