...
Esta pasta existe para consolidar evidências e convenções de empacotamento de marca para auditoria.
...
- `assets/brand/govevia/lockup-stacked.svg`
...
- Govevia (raster atual):
  ...
  - mark: `public/brand/govevia-mark-on-white.png`

> Nota: por serem binários, os PNGs permanecem em `public/brand/` como fonte operacional até existir SVG canônico.
