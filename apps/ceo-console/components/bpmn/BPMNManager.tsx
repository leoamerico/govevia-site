...
const s = {
  ...
  title:       { fontSize: '1.4rem', fontWeight: 700, color: '#1e293b', fontFamily: 'Georgia, serif', margin: 0 } as React.CSSProperties,
  subtitle:    { fontSize: '0.8rem', color: '#64748b', marginTop: '0.2rem' } as React.CSSProperties,
  ...
  btnGhost:    { background: 'transparent', color: '#64748b', border: '1px dashed #cbd5e1', borderRadius: 6, padding: '0.3rem 0.7rem', fontSize: '0.75rem', cursor: 'pointer' } as React.CSSProperties,
